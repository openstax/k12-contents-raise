...
INPUT_DIR = '../../../grouped_html/practiceproblems/thinslice'
OUTPUT_CSV = 'practice_problem_thinslice_no_TEKS.csv'
...
def main():
    ...
    for file in sorted(Path(INPUT_DIR).glob('*.html')):
        rows = process_file(file, "PP_" +str(multi_step_counter), logs)
